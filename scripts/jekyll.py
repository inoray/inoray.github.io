...
c.MarkdownExporter.template_path = ['/home/shkim/blog/inoray.github.io/scripts'] # point this to your jekyll template file
...
if f:
    ...
    c.FilesWriter.build_directory = '/home/shkim/blog/inoray.github.io/_posts' # point this to your build directory
